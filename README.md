...
1. [BPPT Medical Speech Corpus](https://ieeexplore-ieee-org.libproxy1.nus.edu.sg/document/9527450)
   A medical Indonesian speech corpus of 100 speakers (50 male and 50 female), with each of the speaker speaks 600 utterances. The recording process was performed under the supervision of a phonetician. The corpus has a total duration of 81.68 hours.
1. [MEDISCO speech corpus](https://ieeexplore.ieee.org/document/8629259)
   A medical Indonesian speech corpus of 13 speakers  (7 male and 6 female), with each of the speaker speaks 360 utterances. The corpus contains 731 medical terms. The utterances are phonetically balanced and has a total duration of 10 hours speech. The corpus is free to use for academic usage and can be requested through https://bit.ly/medisco-form
